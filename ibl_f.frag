...
void main()
{
    ...
    vec4 albedo_texture_val = texture(p3d_Texture0, v_texcoord);
    vec4 albedo = p3d_Material.baseColor * v_color * p3d_ColorScale * albedo_texture_val;
    ...
    for (int i = 0; i < MAX_LIGHTS; ++i) {
        ...
        float shadow = (shadowSpot * shadowCaster * attenuation_factor) * color.a;
